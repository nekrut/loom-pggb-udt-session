#!/usr/bin/env python3
"""Pairwise synteny strip plot for pangenome5 (subs + indels + rearrangements).
...
truth = pd.read_csv("genomes5/truth.tsv", sep="\t")
...
axes[-1].set_xticklabels(["0","1Mb","0","1Mb"])
...
fig.suptitle("Pairwise synteny vs. ref — truth (pangenome5: subs + indels + rearrangements)",
             y=0.99, fontsize=12)
plt.tight_layout()
plt.savefig("genomes5/synteny_pairwise_truth.png", dpi=140, bbox_inches="tight")
print("wrote genomes5/synteny_pairwise_truth.png")
