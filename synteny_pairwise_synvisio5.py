#!/usr/bin/env python3
"""Pairwise synteny plot for pangenome5 in Synvisio-like style:
...
fig.suptitle("Pairwise synteny — pangenome5 (Synvisio-style ribbons)",
             y=0.99, fontsize=12)
plt.tight_layout()
plt.savefig("genomes5/synteny_pairwise_synvisio.png", dpi=140, bbox_inches="tight")
print("wrote genomes5/synteny_pairwise_synvisio.png")
